...
public class PersonController {
	...
	public boolean updateAddress(@PathVariable String email, 
	...
	public List<Person> getPersonsByAge(@RequestParam int min,
	...
	public List<Person> getEmployeesBySalary(@RequestBody SalaryDto salaryDto){
		return personService
				.getEmployeesBySalary(salaryDto.getMinSalary(),
